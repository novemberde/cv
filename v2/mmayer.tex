...
%  \mailaddress{Address, Street, 00000 County}
  \location{Seoul, 06540, Rep. of KOREA}
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
  \linkedin{linkedin.com/in/novemberde}
  \github{github.com/novemberde} % I'm just making this up though.
...
\cvsection[page1sidebar]{Objective}
  \begin{itemize}
      \item Seeking a position as a DevOps engineer utilizing my technical skills.
  \end{itemize}

\cvsection{Experience}
\cvevent{CTO}{Movilest(movilest.com)}{Nov.2017 - Present}{Seoul, S.Korea}
\begin{itemize}
    \item {Built and published the lock-screen advertisement platform in Mexico.(800k downloads on google play store)}
    \smallskip
...
\cvevent{Software Engineer}{AFI(afidev.com)}{Aug. 2016 - Oct. 2017}{Seoul, S.Korea}
\begin{itemize}
...
\cvsection{Certification \& Education}
    \cvevent{Solutions Architect Associate}{Amazon Web Service}{Apr. 2019}{}
    \cvevent{B.S. in Electric Engineering}{Kwangwoon University}{Mar. 2008 - Exp. Feb. 2014}{Seoul, S.Korea}
% \divider
