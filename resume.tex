...
\address{103, 27-9, Sapyeong-daero 53-gil, Seocho-gu, Seoul, Republic of Korea, 06540, Rep. of KOREA}

\mobile{(+82) 10-2682-2988}
\email{novemberde1@gmail.com}
\homepage{novemberde.github.io}
\github{novemberde}
\linkedin{novemberde}
% \gitlab{gitlab-id}
...
\quote{``Keep going even though you have failed."}
